...
struct OutboundDoubleLineView: View {
            ...
            VStack(alignment: .trailing) {
                ZStack(alignment: .bottomTrailing) {
                    RoundedRectangle(cornerRadius: 18)
                        ...
                        .overlay(
                            Text("Yeah, yeah. But 🚀 ! Is this in Florida?")
...
struct OutboundDoubleLineView_Previews: PreviewProvider {
