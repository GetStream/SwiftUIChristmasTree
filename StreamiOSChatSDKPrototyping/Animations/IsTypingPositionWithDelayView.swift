...
struct IsTypingPositionWithDelayView: View {
                    ...
                    if #available(iOS 15.0, *) {
                        HStack(spacing: 4) {
                            Circle()
                                ...
                                .animation(.easeOut(duration: 1).delay(0.6).repeatForever(autoreverses: true), value: isTyping)
                            Circle()
                                .frame(width: 6, height: 6)
                                .offset(y: isTyping ? 2.5 : -2.5)
                                .animation(.easeInOut(duration: 1).delay(0.6).repeatForever(autoreverses: true), value: isTyping)
                            Circle()
                                .frame(width: 6, height: 6)
                                .offset(y: isTyping ? 2.5 : -2.5)
...
struct IsTypingPositionWithDelayView_Previews: PreviewProvider {
